...
You would do host discovery first (as done in lab 1, so we will skip it).
...
#### **6.5.3.1 Kerbrute username enumeration**
...
```bash
wget https://github.com/uwacyber/cits3006/raw/2025s2/cits3006-labs/files/users.txt
```
