...
![](../.gitbook/assets/lab-3-assets/2.png) 

_Figure 2: Extracted strings with ransom note template and name of the ransomware._
...
![](../.gitbook/assets/lab-3-assets/3.png) 

_Figure 3: Extracted strings with RSA public key and file extensions to be encrypted_
...
![](../.gitbook/assets/lab-3-assets/4.png) 

_Figure 4: Sample overview reported by capa tool_ 

![](../.gitbook/assets/lab-3-assets/5.png) 

_Figure 5: Sample capabilities - file operations; OpenSSL crypto library used._
...
There is lot of cryptography, ciphers, hashes. And it is linked against OpenSSL cryptography library.
...
![](../.gitbook/assets/lab-3-assets/7.png) 

_Figure 7: GitHub repository with FLIRT signatures for OpenSSL_
...
* libcryptoMT_8_msvc_x86.sig
* libcryptoMT_10_msvc_x86.sig
...
![](../.gitbook/assets/lab-3-assets/8.png) 

_Figure 8: Applied IDA FLIRT Signatures for OpenSSL library_
...
![](../.gitbook/assets/lab-3-assets/9.png) 

_Figure 9: Start routine of the analyzed sample_
...
![](../.gitbook/assets/lab-3-assets/10.png) 

_Figure 10: End of the start routine with call to main function_
...
![](../.gitbook/assets/lab-3-assets/11.png) 

_Figure 11: Disassembled main function of the ransomware sample_
...
![](../.gitbook/assets/lab-3-assets/12.png) 

_Figure 12: Disassembled ServiceMain function_
...
![](../.gitbook/assets/lab-3-assets/13.png) 

_Figure 13: "do\_ransomware\_stuff" function called from main and ServiceMain functions_
...
![](../.gitbook/assets/lab-3-assets/14.png) 

_Figure 14: Obtaining the hexadecimal representation of the embedded RSA Public Key’s hash value_
...
![](../.gitbook/assets/lab-3-assets/15.png) 

_Figure 15: Preparation of formatted ransom note message in the ransomware stuff function_ 

![](../.gitbook/assets/lab-3-assets/16.png) 

_Figure 16: Enumeration of logical drives of the infected machine_
...
![](../.gitbook/assets/lab-3-assets/17.png) 

_Figure 17: Hypothesis: function sub\_401640 is responsible for encrypting drive or folder and creation of readme.txt file with ransom note_
...
![](../.gitbook/assets/lab-3-assets/18.png) 

_Figure 18: Removing msupdate service created by this ransomware previously_
...
![](../.gitbook/assets/lab-3-assets/19.png) 

_Figure 19: Cross references to ".CRYPT" and creating the encrypted file by ransomware_
...
![](../.gitbook/assets/lab-3-assets/20.png) 

_Figure 20: DEARCRY! file marker and encryption of AES key with RSA_
...
![](../.gitbook/assets/lab-3-assets/21.png) 

_Figure 21:Prime factors of 2048-bit RSA public key_

Then, the encrypted symmetric key is written as a part of header of the encrypted file after the “DEARCRY!” marker.

![](../.gitbook/assets/lab-3-assets/22.png) 

_Figure 22: OpenSSL functions for encryption. sub\_402F00 has not been identified by used FLIRT signature_
...
![](../.gitbook/assets/lab-3-assets/23.png) 

_Figure 23: EVP\_Cipher type object returned by sub\_402F00_
...
![](../.gitbook/assets/lab-3-assets/24.png) 

_Figure 24: Identification of AES-256-CBC encryption used by DearCry ransomware_
...
![](../.gitbook/assets/lab-3-assets/25.png) 

_Figure 25: Function graph with already analyzed functions_
...
![](../.gitbook/assets/lab-3-assets/26.png) 

_Figure 26: Checking the “DEARCRY!” file marker in sub\_4010C0, followed by encrypt\_file in sub\_4015D0_
...
![](../.gitbook/assets/lab-3-assets/27.png) 

_Figure 27: Function graph related to the files encryption and recursive function encrypt\_drive/folder_
...
![](../.gitbook/assets/lab-3-assets/28.png) 

_Figure 28: Encrypt\_folder function uses Win32 API calls FindFirstFileA and FindNextFileA_

![](../.gitbook/assets/lab-3-assets/29.png) 

_Figure 29: Checking of file extensions to encrypt_
...
![](../.gitbook/assets/lab-3-assets/30.png) 

_Figure 30: Last custom function - ReportServiceStatus_
...
![](../.gitbook/assets/lab-3-assets/31.png) 

_Figure 31: Function graph of analyzed functions reveals the program logic, too_
...
![](../.gitbook/assets/lab-3-assets/32.png) 

_Figure 32: File with .CRYPT extension and "DEARCRY!" file marker_

Also, file readme.txt contains the formatted ransom note message including the contact emails and hash of the RSA key.

![](../.gitbook/assets/lab-3-assets/33.png) 

_Figure 33: Formatted ransom note with emails and hash of the RSA key_
