...
```
wget https://github.com/uwacyber/cits3006/raw/live/cits3006-labs/files/portscan.sh
```
...
```
wget https://github.com/uwacyber/cits3006/raw/live/cits3006-labs/files/rshell.zip
```
